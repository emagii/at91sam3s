 ...
 */
#define SAMGUI_E_OS_TASK_CREATE_FAILED           SAMGUI_ERRORS_PORTING_BASE
#define SAMGUI_E_OS_SEM_CREATE_FAILED            SAMGUI_ERRORS_PORTING_BASE+1
#define SAMGUI_E_OS_SEM_TAKE_FAILED              SAMGUI_ERRORS_PORTING_BASE+2
#define SAMGUI_E_OS_SEM_RELEASE_FAILED           SAMGUI_ERRORS_PORTING_BASE+3
